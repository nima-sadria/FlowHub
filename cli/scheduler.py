"""FlowHub â€” flowhub scheduler command group. Stub â€” B11."""
...
def scheduler_list() -> None:
    """List schedules. [NOT IMPLEMENTED â€” B11]"""
    typer.echo(_NOT_IMPLEMENTED)


@app.command("pause")
def scheduler_pause() -> None:
    """Pause a schedule. [NOT IMPLEMENTED â€” B11]"""
    typer.echo(_NOT_IMPLEMENTED)


@app.command("resume")
def scheduler_resume() -> None:
    """Resume a paused schedule. [NOT IMPLEMENTED â€” B11]"""
    typer.echo(_NOT_IMPLEMENTED)


@app.command("cancel")
def scheduler_cancel() -> None:
    """Cancel a schedule. [NOT IMPLEMENTED â€” B11]"""
    typer.echo(_NOT_IMPLEMENTED)
