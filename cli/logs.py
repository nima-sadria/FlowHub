"""FlowHub â€” flowhub logs command group. Stub â€” B6."""
...
@app.command("tail")
def logs_tail() -> None:
    """Stream logs live. [NOT IMPLEMENTED â€” B6]"""
    typer.echo(_NOT_IMPLEMENTED)


@app.command("show")
def logs_show() -> None:
    """Show recent log lines. [NOT IMPLEMENTED â€” B6]"""
    typer.echo(_NOT_IMPLEMENTED)


@app.command("export")
def logs_export() -> None:
    """Export logs to a file. [NOT IMPLEMENTED â€” B6]"""
    typer.echo(_NOT_IMPLEMENTED)
