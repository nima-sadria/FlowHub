"""FlowHub â€” flowhub channels command group. Stub â€” B8."""
...
def channels_list() -> None:
    """List configured channels. [NOT IMPLEMENTED â€” B8]"""
    typer.echo(_NOT_IMPLEMENTED)


@app.command("add")
def channels_add() -> None:
    """Add a channel. [NOT IMPLEMENTED â€” B8]"""
    typer.echo(_NOT_IMPLEMENTED)


@app.command("test")
def channels_test() -> None:
    """Test channel connectivity. [NOT IMPLEMENTED â€” B8]"""
    typer.echo(_NOT_IMPLEMENTED)


@app.command("remove")
def channels_remove() -> None:
    """Remove a channel. [NOT IMPLEMENTED â€” B8]"""
    typer.echo(_NOT_IMPLEMENTED)
