...
- [Current architecture](../../evidence/architecture/CURRENT_ARCHITECTURE.md)
- [Unified Multi-Channel Workspace](../../evidence/architecture/UNIFIED_MULTI_CHANNEL_WORKSPACE.md)
- [Release notes](RELEASE_NOTES.md)
- [Roadmap](../../archive/roadmaps/ROOT_ROADMAP.md)
