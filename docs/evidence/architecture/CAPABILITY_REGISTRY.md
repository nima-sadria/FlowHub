...
2. Read [`docs/evidence/architecture/CURRENT_ARCHITECTURE.md`](CURRENT_ARCHITECTURE.md),
   [`docs/evidence/architecture/BU5_INTEGRATIONS.md`](BU5_INTEGRATIONS.md), and the
...
- **test surface:** `tests/flowhub/test_digikala_connector.py`, Commerce Hub
  ...
  registration tests.
- **evidence:** `docs/reference/channel-api/digikala-api.md`; it explicitly documents
