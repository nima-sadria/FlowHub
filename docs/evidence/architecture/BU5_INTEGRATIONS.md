...
- `docs/evidence/architecture/CURRENT_ARCHITECTURE.md`
- `docs/evidence/architecture/INTEGRATION_PLATFORM.md`
- `docs/evidence/architecture/DATA_LAYER_ARCHITECTURE.md`
