...
**Scope:** Implement the three code changes documented in `docs/archive/legacy-compatibility/PHASE_5_CUTOVER_PLAN.md`.
...
1. `README.md`
2. `docs/evidence/workflows/WORKFLOW.md`
3. `docs/archive/legacy-compatibility/ARCHITECTURE.md`
4. `docs/operations/MIGRATION_STATUS.md`
5. `docs/ROADMAP.md`
6. `docs/archive/legacy-compatibility/PHASE_5_CUTOVER_PLAN.md` - the source of truth for all Phase 6 code changes

---

## Phase 6 Scope

Implement exactly the three changes listed in `docs/archive/legacy-compatibility/PHASE_5_CUTOVER_PLAN.md` under **"Proposed Phase 6 Changes"**:
...
Follow `docs/development/agents/STABILIZATION_COMMIT.md`.
...
Submit the commit hash and the required report (see `docs/archive/legacy-compatibility/agents/CLAUDE_DEVELOPER.md`) for Codex audit.
...
8. **Known limitations** - see Open Findings in `docs/operations/MIGRATION_STATUS.md`
