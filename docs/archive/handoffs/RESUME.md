...
- No authority-management API or UI was added. `docs/development/contracts/FRONTEND_CONTRACT.md` remains
...
- `docs/evidence/architecture/PRICING_MATRIX_DESIGN.md`
- `docs/evidence/architecture/SOURCE_ACQUISITION_DESIGN.md`
...
- `docs/evidence/architecture/ADR_SOURCE_UI_OBSERVABILITY_ADDENDUM.md`
- `docs/evidence/architecture/PRICING_UI_CONTRACT.md`
...
`docs/development/contracts/FRONTEND_CONTRACT.md` is the callable backend contract for the frontend team.
...
- `docs/evidence/architecture/SOURCE_SCHEMA_ASSESSMENT_CONTRACT.md`
- `tests/flowhub/source_acquisition/test_schema_assessment.py`
- `tests/flowhub/migration/test_source_schema_assessments_027.py`
