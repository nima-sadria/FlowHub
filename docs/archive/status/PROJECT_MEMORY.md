...
`docs/development/contracts/FRONTEND_CONTRACT.md` is authoritative for what the current frontend may call.
...
`docs/evidence/architecture/PRICING_UI_CONTRACT.md` is proposed future architecture only.
...
- The backend repo owns `docs/development/contracts/FRONTEND_CONTRACT.md`; changes to callable behavior must update it together with `RESUME.md`.
