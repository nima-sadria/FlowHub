...
`docs/evidence/architecture/PRICING_UI_CONTRACT.md`: that document defines the future
...
- The Workspace pricing preview and apply-result APIs described in
  `docs/evidence/architecture/PRICING_UI_CONTRACT.md` are not delivered by this
...
frontend without updating this file and `docs/archive/handoffs/RESUME.md` in the same backend commit.
