...
def test_unavailable_skip_sets_skip_status():
    r = HealthCheckResult.unavailable_skip("docker", CheckCategory.DOCKER)
    assert r.status == HealthStatus.SKIP


def test_unavailable_skip_sets_not_implemented_reason():
    r = HealthCheckResult.unavailable_skip("docker", CheckCategory.DOCKER)
