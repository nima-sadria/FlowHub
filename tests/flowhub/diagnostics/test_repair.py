...
from app.flowhub.diagnostics.repair import ProbableCauseInferrer, RepairPlaybook
from app.flowhub.diagnostics.report import RepairStep
        ...
        for fc in FailureClass:
            ...
            for step in steps:
                if step.command:
                    ...
                    assert "FLOWHUB_POSTGRES_PASSWORD" not in step.command
                    assert "FLOWHUB_NEXTCLOUD_PASSWORD" not in step.command
