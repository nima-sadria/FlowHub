...
# Set env vars BEFORE importing any app.flowhub modules so the lru_cache in
# database.py picks up the test URL on first call.
os.environ.setdefault("FLOWHUB_DATABASE_URL", "sqlite:///:memory:")
os.environ.setdefault("FLOWHUB_JWT_SECRET", "test-bu2-jwt-secret-32-bytes-min!")

from app.flowhub.database import FlowHubBase, _get_engine  # noqa: E402
from app.flowhub.auth import models as _models  # noqa: E402, F401  - registers tables
