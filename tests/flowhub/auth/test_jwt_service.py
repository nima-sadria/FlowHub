"""Tests for app/flowhub/auth/jwt_service.py"""
...
from app.flowhub.auth.jwt_service import create_access_token, decode_access_token
...
class TestDecodeAccessToken:
    ...
    def test_raises_on_wrong_type_claim(self, monkeypatch):
        import os, jwt
        secret = os.environ["FLOWHUB_JWT_SECRET"]
