...
TestDoubleNetworkAdapter provides controlled, in-memory responses with NO real
...
class TestDoubleNetworkAdapter(NetworkAdapter):
    """Controllable test_double adapter for unit tests - no real network calls."""
