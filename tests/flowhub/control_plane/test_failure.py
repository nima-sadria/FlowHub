"""Tests for app.flowhub.control_plane.failure - FailureClass and Severity."""

import json

import pytest

from app.flowhub.control_plane.failure import FailureClass, FailureClassMeta, Severity
