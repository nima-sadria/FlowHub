...
describe('Channels page', () => {
  ...
  async function render() {
    await act(async () => {
      root.render(<AuthContext.Provider value={admin}><NotificationProvider><MemoryRouter><ServiceProvider services={services}><Channels /></ServiceProvider></MemoryRouter></NotificationProvider></AuthContext.Provider>)
