...
export const sourceWorkspaceApi = {
  ...
  saveMapping: (sourceId: string, payload: SourceMappingSaveRequest) => apiFetch<SourceMapping>(`/api/v2/sources/${encodeURIComponent(sourceId)}/mappings`, authFetch, json('PUT', payload)),
  ...
  previewUnsavedMapping: (sourceId: string, payload: SourceMappingSaveRequest) => apiFetch<SourcePreview>(`/api/v2/sources/${encodeURIComponent(sourceId)}/preview?page=1&pageSize=100`, authFetch, json('POST', payload)),
