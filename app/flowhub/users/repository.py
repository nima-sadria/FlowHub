...
Persistence layer for FlowHubUser and Permission records.
...
class UserRepository:
    ...
    def create(self, *, email: str, hashed_password: str, is_admin: bool = False) -> "FlowHubUser":
    ...
    def get_by_id(self, user_id: str) -> "FlowHubUser":
    ...
    def get_by_email(self, email: str) -> "FlowHubUser":
