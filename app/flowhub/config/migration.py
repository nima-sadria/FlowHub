...
Detects when a managed TOML config file is from an older FLOWHUB version
...
in future phases when the config schema evolves between FLOWHUB releases.
"""
...
CURRENT_CONFIG_VERSION = "FLOWHUB-1.0.0"
...
class ConfigMigration:
    ...
    New steps are added here when the config schema changes between FLOWHUB releases.
