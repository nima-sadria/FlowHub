"""FlowHub - /api/v2/health router (CP1.3 contract unavailables).
...
The public endpoint is in app/flowhub/api/health.py.
This file defines the authenticated v2 contract.

Authentication note: All endpoints in this router require a valid JWT.
Auth middleware is implemented in B7. Unavailables are unauthenticated in CP1.
"""
