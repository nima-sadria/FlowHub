...
_FAILURE_METADATA: dict[str, FailureClassMeta] = {
    ...
    "permission_error": FailureClassMeta(
        ...
        operator_hint=(
            ...
            "Check file system permissions for the application user on FLOWHUB_STORAGE_PATH."
        ),
        retryable=False,
        security_sensitive=False,
    ),
    "storage_error": FailureClassMeta(
        ...
        operator_hint=(
            "FLOWHUB_STORAGE_PATH is missing, not mounted, or the disk is full. "
            "Check mount points and available disk space. "
            "Run: df -h && ls -la $FLOWHUB_STORAGE_PATH"
        ),
        retryable=False,
        security_sensitive=False,
    ),
    "database_error": FailureClassMeta(
        ...
        operator_hint=(
            ...
            "Check that the database container is running and FLOWHUB_DATABASE_URL is correct. "
