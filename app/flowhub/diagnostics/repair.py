...
_PLAYBOOKS: dict[str, list[dict]] = {
    "dns_failure": [
        ...
        },
        {
            ...
            "command": "flowhub configure set FLOWHUB_NEXTCLOUD_URL https://correct-host.example.com",
        },
        {
    ...
    "timeout": [
        ...
        },
        {
            ...
            "command": "flowhub configure set FLOWHUB_NEXTCLOUD_URL <url>",
        },
        {
    ...
    "permission_error": [
        {
            ...
            "command": "ls -la $FLOWHUB_STORAGE_PATH",
        },
        {
            "description": "Correct ownership for the application user",
            "command": "chown -R <app_user>: $FLOWHUB_STORAGE_PATH",
        },
    ],
    "storage_error": [
        {
        ...
        },
        {
            ...
            "command": "mkdir -p $FLOWHUB_STORAGE_PATH",
        },
    ],
    "database_error": [
        {
        ...
        {
            "description": "Verify FLOWHUB_DATABASE_URL is correct",
            "command": "flowhub configure show",
        },
    ],
    "docker_error": [
