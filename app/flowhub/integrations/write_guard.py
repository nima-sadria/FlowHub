...
instead of proceeding.  This is intentional and permanent for the FLOWHUB phase.
"""
...
FLOWHUB_WRITE_BLOCKED = "Write operations are disabled in FlowHub."


def raise_write_blocked() -> None:
    """Raise HTTP 403 immediately.  Call this from any endpoint that would write."""
    raise HTTPException(status_code=403, detail=FLOWHUB_WRITE_BLOCKED)
