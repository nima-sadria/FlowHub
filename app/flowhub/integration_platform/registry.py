...
_DEFINITIONS: dict[str, ConnectorDefinition] = {
    ...
    "snappshop": ConnectorDefinition(
        ...
        settings_schema=[
            ...
            ConnectorSettingDefinition(key="agent_header_name", label="Agent header name", required=False),
            ConnectorSettingDefinition(key="request_timeout", label="Request timeout seconds", required=False),
    ...
    "tapsishop": ConnectorDefinition(
        ...
        settings_schema=[
            ...
            ConnectorSettingDefinition(key="token_refresh_enabled", label="Token refresh enabled", required=False),
            ConnectorSettingDefinition(key="token_refresh_name", label="Token refresh name", required=False),
            ConnectorSettingDefinition(key="revoke_current_token", label="Revoke current token on refresh", required=False),
