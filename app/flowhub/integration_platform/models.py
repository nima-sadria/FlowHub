...
class IntegrationConnectorInstance(FlowHubBase):
...
class IntegrationConnectorSetting(FlowHubBase):
...
class IntegrationConnectorHealthSnapshot(FlowHubBase):
...
class IntegrationConnectorEvent(FlowHubBase):
...
class IntegrationConnectorDiagnostic(FlowHubBase):
...
class IntegrationConnectorTelemetry(FlowHubBase):
...
class IntegrationWebhookEvent(FlowHubBase):
...
class IntegrationPollingPolicy(FlowHubBase):
