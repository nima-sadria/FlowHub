...
def upgrade() -> None:
    ...
    op.create_index("ix_flowhub_write_batches_channel_id", "flowhub_write_batches", ["channel_id"])
    op.create_index("ix_flowhub_write_batches_channel_type", "flowhub_write_batches", ["channel_type"])
    op.create_index("ix_flowhub_write_batches_operation_type", "flowhub_write_batches", ["operation_type"])
    op.create_index("ix_flowhub_write_batches_status", "flowhub_write_batches", ["status"])
    ...
    op.create_index("ix_flowhub_write_items_batch_id", "flowhub_write_items", ["batch_id"])
    op.create_index("ix_flowhub_write_items_channel_product_id", "flowhub_write_items", ["channel_product_id"])
    op.create_index("ix_flowhub_write_items_status", "flowhub_write_items", ["status"])
    ...
    op.create_index("ix_flowhub_write_events_batch_id", "flowhub_write_events", ["batch_id"])
    op.create_index("ix_flowhub_write_events_item_id", "flowhub_write_events", ["item_id"])
    op.create_index("ix_flowhub_write_events_event_type", "flowhub_write_events", ["event_type"])
