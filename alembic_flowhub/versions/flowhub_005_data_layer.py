"""FLOWHUB_005 - create Data Layer tables (dl_*)

Establishes the FlowHub Data Layer persistence foundation.
All tables use the 'dl_' prefix to distinguish them from core FLOWHUB tables.
...
Safety: no WooCommerce or Nextcloud write paths are introduced.
        These tables are populated by flowhub read operations only.

Revision ID: FLOWHUB_005
Revises: FLOWHUB_004
...
revision = "FLOWHUB_005"
down_revision = "FLOWHUB_004"
branch_labels = None
depends_on = None
